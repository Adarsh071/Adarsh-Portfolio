...
const Hero = ({darkMode}) => {
  const socialIcons = [
    {icon: instagram, alt: 'Instagram', link: 'https://instagram.com/adarsh_coder'},
    {icon: linkedin, alt: 'linkedin', link: 'https://www.linkedin.com/in/adarsh-kumar-arlo/'},
    {icon: github, alt: 'github', link: 'https://github.com/Adarsh071'},
    {icon: youtube, alt: 'youtube', link: 'https://youtube.com/@AdarshCoder'},    
  ];
      ...
      className='body-font z-10'>
        <div className='container mx-auto flex px-4 sm:px-8 lg:px-14 py-12 lg:py-32 flex-col lg:flex-row items-center justify-between lg:mt-0 mt-14'>
          <div className='lg:w-1/2 w-full flex flex-col items-center lg:items-start text-center lg:text-left mb-12 lg:mb-0'>
            ...
            data-aos='fade-up'
            data-aos-delay='600'>
              A Computer Science student and aspiring Software Engineer passionate about full-stack web development. I build responsive, modern, and scalable web applications using React, Node.js, Express, MongoDB, and Tailwind CSS while continuously learning new technologies and solving real-world problems.
            </p>
            {/* Button */}
