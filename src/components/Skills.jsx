  ...
  return (
    ...
    >
      <div className="py-2 relative overflow-hidden">
        <div className="container px-5 py-8 lg:py-18 mx-auto">
          <div className="text-center mb-20" data-aos="fade-up">
            <h1
              className="sm:text-4xl text-3xl lg:text-5xl font-bold title-font mb-4"
              style={{
            ...
            >
              My technical expertise in frontend, backend, databases, and development tools.
            </p>
          </div>
          <div
              ...
              >
                <div
                  ...
                  className="h-full p-6 rounded-2xl border hover:border-orange-500/50
                          transition-all duration-300 hover:-translate-y-2 group hover:shadow-[0_0_30px_rgb(255,165,0,0,0.15)]"
                >
